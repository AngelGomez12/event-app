      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-violet-950 via-violet-900 to-slate-900">
        <Card size="4" style={{ width: '100%', maxWidth: 480 }}>
          <Flex direction="column" gap="4" align="center">
            <Heading size="7" weight="bold">¡Registro Exitoso!</Heading>
            <Text size="3" color="gray" align="center">
              Tu salón ha sido creado correctamente. Ya podés empezar a gestionarlo.
            </Text>
            <Button size="3" color="violet" onClick={() => router.push('/login')}>
              Ir al Login
            </Button>
          </Flex>
        </Card>
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-violet-950 via-violet-900 to-slate-900">
      <Card size="4" style={{ width: '100%', maxWidth: 480 }}>
        <Flex direction="column" gap="1" mb="5" align="center">
          <Heading size="7" weight="bold">Crea tu Salón</Heading>
          <Text size="2" color="gray">Comienza a gestionar tus eventos hoy mismo</Text>
        </Flex>

        <form onSubmit={handleRegister}>
          <Flex direction="column" gap="4">
            <Box>
              <Text as="label" size="2" weight="medium" htmlFor="salonName">Nombre del Salón</Text>
              <TextField.Root
                name="salonName"
                id="salonName"
            ...
            <Box>
              <Text as="label" size="2" weight="medium" htmlFor="email">Email del Administrador</Text>
              <TextField.Root
                name="email"
                id="email"
                type="email"
            ...
            <Box>
              <Text as="label" size="2" weight="medium" mb="1">Plan de Suscripción</Text>
              <Select.Root value={plan} onValueChange={(v) => setPlan(v as SubscriptionPlan)}>
                <Select.Trigger size="3" />
                <Select.Content>
                  <Select.Item value={SubscriptionPlan.BASIC}>Plan Básico (UYU 0/mes)</Select.Item>
                  <Select.Item value={SubscriptionPlan.PREMIUM}>Plan Premium (UYU 1500/mes)</Select.Item>
                  <Select.Item value={SubscriptionPlan.ENTERPRISE}>Plan Enterprise (Consultar)</Select.Item>
                </Select.Content>
              </Select.Root>
            </Box>
            ...
            <Flex justify="center" mt="2">
              <Text size="2">
                ¿Ya tienes un salón?{' '}
                <Link href="/login" style={{ color: 'var(--violet-10)', fontWeight: 600 }}>
                  Inicia sesión
                </Link>
              </Text>
            </Flex>
